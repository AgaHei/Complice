# image_module_dalle.py - Alternative avec OpenAI DALL-E
...
def generate_emotion_image(prompt: str, model="dall-e-3"):
    ...
    try:
        ...
        enhanced_prompt = f"Digital art, high quality: {prompt}"
        ...
        print(f"❌ Erreur lors de la génération DALL-E : {e}")
        return None

# 📸 Version économique avec DALL-E 2 (moins coûteuse)
def generate_emotion_image_budget(prompt: str):
    """
    Version économique avec DALL-E 2
    """
